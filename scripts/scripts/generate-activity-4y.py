...
def x_pos(index):
    ...
    return plot_left + (index * plot_width / (len(values) - 1))


def y_pos(value):
    return plot_bottom - (value / max_value * plot_height * 0.85)
...
for fraction in [0, 1 / 3, 2 / 3, 1]:
    ...
    y = plot_bottom - (fraction * plot_height * 0.85)
